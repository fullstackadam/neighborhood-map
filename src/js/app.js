...
ko.applyBindings(LOCATION, document.getElementById('locationModel'));
ko.applyBindings(PLACE, document.getElementById('placeModel'));
//ko.applyBindings(MAP, document.getElementById('mapModel'));
